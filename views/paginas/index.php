...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de WeCamp</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para WeCamp</p>


    <div class="boletos__grid">
        <div   class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;WeCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$500</p>
    ...
    <div class="boleto__enlace-contenedor">
        <a href="/pases" class="boleto__enlace">Comprar Entradas</a>
    </div>
</section>